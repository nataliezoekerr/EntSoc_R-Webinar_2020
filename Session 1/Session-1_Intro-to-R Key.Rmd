...
spray.boxplot <- ggplot(data=dat, aes(x=spray, y=count, fill=spray))+geom_boxplot()+
  theme+scale_fill_manual(values=palette1)+xlab("Insects")+ylab("Sprays")+guides(fill=F)
